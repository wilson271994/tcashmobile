      ...
      <SafeAreaView style={profilstyle.container2}>
        <View style={[profilstyle.container2]}>
          <ScrollView contentContainerStyle={profilstyle.scrollContainer}>
            ...
            style={profilstyle.logoutContainer}>
              <Text style={profilstyle.out}>Se déconnecter</Text>
            </TouchableOpacity>
          </ScrollView>
        </View>
      </SafeAreaView>
...
export default connect(mapStateToProps, mapDispatchToProps, null)(Settings);